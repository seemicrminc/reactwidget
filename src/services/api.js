...
export const widgetAPI = {
  ...
  submitWidget: (data, apiBaseUrl = PUBLIC_API_BASE_URL) => {
  ...
  submitSignup: (data, apiBaseUrl = PUBLIC_API_BASE_URL) => {
    return axios.post(`${apiBaseUrl}/public/widgets/submit`, data, {
      headers: {
        "Content-Type": "application/json",
      },
  ...
  submitLogin: (
    ...
    formData.append(
      "operatingSystem",
      credentials.operatingSystem || "unknown"
    );
  ...
  submitContact: (data, apiBaseUrl = PUBLIC_API_BASE_URL) => {
    return axios.post(`${apiBaseUrl}/public/widgets/submit`, data, {
      headers: {
        "Content-Type": "application/json",
      },
  ...
  submitBooking: (data, apiBaseUrl = PUBLIC_API_BASE_URL) => {
    return axios.post(`${apiBaseUrl}/public/widgets/submit`, data, {
      headers: {
        "Content-Type": "application/json",
      },
  ...
  getAvailableSlots: (widgetId, params) => {
    return api.get(`/widgets/available-slots?widget_id=${widgetId}`, {
      params,
    });
  },
};
...
export const customFieldsAPI = {
  listCustomFields: (appDetailId) =>
    api.get(`/custom-fields/list?app_detail_id=${appDetailId}`),
  createCustomField: (data) => api.post("/custom-fields/create", data),
  updateCustomField: (id, data) =>
    api.post(`/custom-fields/update?field_id=${id}`, data),
